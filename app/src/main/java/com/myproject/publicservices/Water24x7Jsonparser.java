 ...
 */
public class Water24x7Jsonparser {
    ...
    public static final String KEY_COLUMN2 = "reservoir_name";
    public static final String KEY_COLUMN3 = "source";
    public static final String KEY_COLUMN4 = "now_avaliable";
    public static final String KEY_COLUMN5 = "address";
    public static final String KEY_COLUMN6 = "last_cleaned";
    ...
    public Water24x7Jsonparser(String json){
        this.json = json;
    }
    ...
    protected void parseJSON(){
        ...
        try {
            ...
            for(int i=0;i<users.length();i++){
                ...
                Log.v("Column2",jo.getString(KEY_COLUMN2));
                column3[i] = jo.getString(KEY_COLUMN3);
                Log.v("Column3",jo.getString(KEY_COLUMN3));
                column4[i] = jo.getString(KEY_COLUMN4);
                Log.v("Column4",jo.getString(KEY_COLUMN4));
