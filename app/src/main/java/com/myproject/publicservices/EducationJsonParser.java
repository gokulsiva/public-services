...
public class EducationJsonParser {
    ...
    public static final String KEY_COLUMN2 = "school_name";
    public static final String KEY_COLUMN3 = "principal_name";
    public static final String KEY_COLUMN4 = "address";
    public static final String KEY_COLUMN5 = "upto";
    public static final String KEY_COLUMN6 = "contact";
    ...
    public EducationJsonParser(String json){
        this.json = json;
    }
